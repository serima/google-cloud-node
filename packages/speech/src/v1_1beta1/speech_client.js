 ...
 * https://github.com/googleapis/googleapis/blob/master/google/cloud/speech/v1_1beta1/cloud_speech.proto,
...
function SpeechClient(gaxGrpc, grpcClients, opts) {
  ...
  this.longrunningDescriptors = {
    longRunningRecognize: new gax.LongrunningDescriptor(
      ...
      grpcClients.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse.decode,
      grpcClients.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata.decode)
  };
  ...
  var speechStub = gaxGrpc.createStub(
      grpcClients.google.cloud.speech.v1p1beta1.Speech,
      opts);
 ...
 *
 * var client = speech.v1_1beta1({
 *   // optional auth parameters.
 * });
 *
 * var encoding = speech.v1_1beta1.types.RecognitionConfig.AudioEncoding.FLAC;
...
function SpeechClientBuilder(gaxGrpc) {
  ...
  extend(this, speechClient.google.cloud.speech.v1p1beta1);
